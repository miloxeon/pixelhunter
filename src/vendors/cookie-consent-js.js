		...
		this.documentReady(function () {
			...
			if (!this.modal) {
				...
				this.modal.querySelector(".btn-accept-necessary").addEventListener("click", function () {
					this.setCookie(self.props.cookieName, "false", 365)
					this.hideDialog()
					if (self.props.postSelectionCallback) {
						self.props.postSelectionCallback(false)
					}
				}.bind(this))
				this.modal.querySelector(".btn-accept-all").addEventListener("click", function () {
					this.setCookie(self.props.cookieName, "true", 365)
					this.hideDialog()
					if (self.props.postSelectionCallback) {
						self.props.postSelectionCallback(true)
					}
				}.bind(this))
			} else {
